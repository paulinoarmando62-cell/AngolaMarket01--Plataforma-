    ...
    <header className="sticky top-0 z-40 bg-white text-stone-900 shadow-sm border-b border-stone-200">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 sm:py-3.5">
        <div className="flex items-center justify-between gap-3 md:gap-5">
          ...
          >
            <div className="w-10 h-10 rounded-2xl bg-red-600 flex items-center justify-center font-black text-white text-base shadow-sm">
              AO<span className="text-amber-300">01</span>
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-lg md:text-xl font-black tracking-tight text-stone-900 group-hover:text-red-600 transition-colors">
                  AngolaMarket
                </span>
                <span className="bg-stone-900 text-white text-xs font-black px-1.5 py-0.5 rounded-md">
                  01
                </span>
              </div>
              <p className="text-[10px] text-stone-500 tracking-wide uppercase font-semibold">
                Marketplace Oficial Luanda
              </p>
            </div>
          </button>

          {/* Location Picker (Luanda Zone with live fees) */}
            ...
            <div className="relative">
              ...
              {searchTerm && (
                <button
                  ...
                  className="absolute right-3 top-2.5 text-stone-400 hover:text-stone-800"
                >
                  <X className="w-4 h-4" />
                </button>
              )}
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
              ...
              {currentUser ? (
                <div>
                  <button
                    ...
                    className="flex items-center gap-1.5 p-1.5 sm:px-3 sm:py-1.5 rounded-2xl bg-stone-100 hover:bg-stone-200 border border-stone-200 text-xs font-bold transition-all cursor-pointer"
                  >
                    <img 
            ...
            <button
              id="cart-drawer-btn"
              onClick={onOpenCart}
              className="relative flex items-center gap-2 px-3.5 py-2.5 rounded-2xl bg-stone-900 hover:bg-black text-white text-xs md:text-sm font-bold shadow-sm transition-all transform active:scale-95 cursor-pointer"
            >
              <ShoppingCart className="w-4 h-4 text-white" />
              <span className="hidden sm:inline">Carrinho</span>
              {cartCount > 0 ? (
                <span className="bg-red-600 text-white text-xs font-black px-2 py-0.5 rounded-full font-mono">
                  {cartCount}
                </span>
              ) : (
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-2xl bg-stone-100 text-stone-700 hover:bg-stone-200 cursor-pointer"
            >
